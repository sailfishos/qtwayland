...
%package plugin-graphics-intergration-client-drm-egl
Summary:    DRM EGL client graphics integration plugin for QtWayland

%description plugin-platform-generic
%{summary}.

%package plugin-graphics-intergration-client-qt-egl
Summary:    Qt EGL plugin client graphics integration plugin for QtWayland

%description plugin-graphics-intergration-client-qt-egl
%{summary}.

%package plugin-graphics-intergration-server-drm-egl
Summary:    DRM EGL server graphics integration plugin for QtWayland

%description plugin-graphics-intergration-server-drm-egl
%{summary}.

%package plugin-graphics-intergration-server-wayland-egl
Summary:    Wayland EGL server graphics integration plugin for QtWayland

%description plugin-graphics-intergration-server-wayland-egl
%{summary}.
...
%files plugin-graphics-intergration-client-drm-egl
%defattr(-,root,root,-)
